        ...
        <div class="row">
          <div class="col">
            <div class="mb-3">
              ...
              <input type="text" class="form-control" name="phone_1" id="phone_1" aria-describedby="phone_1" value="{{ $profile->phone_1 ?? old('phone_1') }}">
          ...
          <div class="col">
            <div class="mb-3">
              ...
              <input type="text" class="form-control" name="phone_2" id="phone_2" aria-describedby="phone_2" value="{{ $profile->phone_2 ?? old('phone_2') }}">
          ...
          <div class="row">
            <div class="col">
              <div class="mb-3">
                ...
                <input type="email" class="form-control" name="another_email" id="another_email" aria-describedby="another_email" value="{{  $profile->another_email ?? old('another_email') }}">
            ...
            <div class="col">
              <div class="mb-3">
                ...
                <input type="text" class="form-control" name="website" id="website" aria-describedby="website" value="{{ $profile->website ?? old('website') }}">
          ...
          <div class="row">
            <div class="col">
              <div class="mb-3">
                ...
                <input type="url" class="form-control" name="linked_in" id="linked_in" aria-describedby="linked_in" value="{{ $profile->linked_in ?? old('linked_in') }}">
            ...
            <div class="col">
              <div class="mb-3">
                ...
                <input type="text" class="form-control" name="twitter" id="twitter" aria-describedby="twitter" value="{{ $profile->twitter ?? old('twitter') }}">
          ...
          <div class="row">
            <div class="col">
              <div class="mb-3">
                ...
                <input type="text" class="form-control" name="languages_spoken" id="languages_spoken" aria-describedby="languages_spoken" value="{{ $profile->languages_spoken ?? old('languages_spoken') }}" placeholder="english,kiswahili,e.t.c">
            ...
            <div class="col">
              <div class="mb-3">
                ...
                <input type="text" class="form-control" name="languages_written" id="languages_written" aria-describedby="languages_written" value="{{ $profile->languages_written ?? old('languages_written') }}" placeholder="english,kiswahili,e.t.c">
          ...
          <div class="mb-3">
            <label for="biography" class="form-label">
              ...
              <textarea class="form-control" id="biography" name="biography" rows="3">
                {{ $profile->biography ?? old('biography') }}
              </textarea>
          ...
          <div class="mb-3">
            <label for="academic_achievement_1" class="form-label">
              ...
              <textarea class="form-control" id="academic_achievement_1" name="academic_achievement_1" rows="3">
                {{ $profile->academic_achievement_1 ?? old('academic_achievement_1') }}
              </textarea>
          ...
          <div class="mb-3">
            <label for="academic_achievement_2" class="form-label">
              ...
              <textarea class="form-control" id="academic_achievement_2" name="academic_achievement_2" rows="3">
                {{ $profile->academic_achievement_2 ?? old('academic_achievement_2') }}
              </textarea>
          ...
          <div class="mb-3">
            <label for="academic_achievement_3" class="form-label">
              ...
              <textarea class="form-control" id="academic_achievement_3" name="academic_achievement_3" rows="3">
                {{ $profile->academic_achievement_3 ?? old('academic_achievement_3') }}
              </textarea>
          ...
          <div class="mb-3">
            <label for="academic_achievement_4" class="form-label">
              ...
              <textarea class="form-control" id="academic_achievement_4" name="academic_achievement_4" rows="3">
                {{ $profile->academic_achievement_4 ?? old('academic_achievement_4') }}
              </textarea>
          ...
          <div class="mb-3">
            <label for="academic_achievement_5" class="form-label">
              ...
              <textarea class="form-control" id="academic_achievement_5" name="academic_achievement_5" rows="3">
                {{ $profile->academic_achievement_5 ?? old('academic_achievement_5') }}
              </textarea>
          ...
          <div class="mb-3">
            <label for="professional_achievement_1" class="form-label">
              ...
              <textarea class="form-control" id="professional_achievement_1" name="professional_achievement_1" rows="3">
                {{ $profile->professional_achievement_1 ?? old('professional_achievement_1') }}
              </textarea>
          ...
          <div class="mb-3">
            <label for="professional_achievement_2" class="form-label">
              ...
              <textarea class="form-control" id="professional_achievement_2" name="professional_achievement_2" rows="3">
                {{ $profile->professional_achievement_2 ?? old('professional_achievement_2') }}
              </textarea>
          ...
          <div class="mb-3">
            <label for="professional_achievement_3" class="form-label">
              ...
              <textarea class="form-control" id="professional_achievement_3" name="professional_achievement_3" rows="3">
                {{ $profile->professional_achievement_3 ?? old('professional_achievement_3') }}
              </textarea>
          ...
          <div class="mb-3">
            <label for="professional_achievement_4" class="form-label">
              ...
              <textarea class="form-control" id="professional_achievement_4" name="professional_achievement_4" rows="3">
                {{ $profile->professional_achievement_4 ?? old('professional_achievement_4') }}
              </textarea>
          ...
          <div class="mb-3">
            <label for="professional_achievement_5" class="form-label">
              ...
              <textarea class="form-control" id="professional_achievement_5" name="professional_achievement_5" rows="3">
                {{ $profile->professional_achievement_5 ?? old('professional_achievement_5') }}
              </textarea>

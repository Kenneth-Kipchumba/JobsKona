  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <!-- Edit Modal -->
        <div class="modal fade" id="edit-{{ $role->id }}" tabindex="-1" aria-labelledby="RoleLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="RoleLabel">Edit {{ $role->name }}  Role</h5>
            ...
            <div class="modal-body">
              <form action="{{ route('admin.roles.update', $role->id) }}" method="POST">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="name" name="name" aria-describedby="user_role" value="{{ $role->name }}">
